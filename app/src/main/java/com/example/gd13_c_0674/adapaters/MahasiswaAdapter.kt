package com.example.gd13_c_0674.adapaters
...
import com.example.gd13_c_0674.AddEditActivity
import com.example.gd13_c_0674.MainActivity
import com.example.gd13_c_0674.R
import com.example.gd13_c_0674.models.Mahasiswa
import java.util.*
...
class MahasiswaAdapter (private var mahasiswaList: List<Mahasiswa>, context: Context) :
    ...
    private var filterMahasiswaList: MutableList<Mahasiswa>
    private val context: Context

    init {
        filterMahasiswaList = ArrayList(mahasiswaList)
    ...
    override fun getItemCount(): Int {
        return filterMahasiswaList.size
    }

    fun setMahasiswaList(mahasiswaList: Array<Mahasiswa>) {
        this.mahasiswaList = mahasiswaList.toList()
        filterMahasiswaList = mahasiswaList.toMutableList()
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val mahasiswa = filterMahasiswaList[position]
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            ...
            override fun publishResults(charSequence: CharSequence, filterResults: FilterResults) {
                ...
                filterMahasiswaList.addAll((filterResults.values as List<Mahasiswa>))
